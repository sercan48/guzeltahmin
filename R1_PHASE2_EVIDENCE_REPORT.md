...
**Generated:** 2026-06-16T12:03:01.201669+00:00  
...
HOME_WIN           81.2%            0.0%             6.2%
DRAW                0.0%          100.0%            93.8%
AWAY_WIN           18.8%            0.0%             0.0%
distinct               2               1                2
```
Diversity ratio (LOOCV distinct / identity distinct): **1.00**  
DRAW share of LOOCV predictions: **93.8%**  
Draw-rate bias — identity: +29.55pp (CRITICAL)  vs isotonic LOOCV: +2.63pp (NORMAL)

## 8. CALIBRATION CURVES (reliability bins, gated n>=20)
STUB(n<20) — calibration curves require n>=20 settled fixtures; n=16 currently.

## 9. AUTOMATIC REJECTION CHECK
Per checkpoint protocol, isotonic is auto-rejected if ANY of:
```
diversity_ratio < 0.50                : clear  (ratio=1.00)
DRAW share (LOOCV) > 70%               : TRIGGERED  (93.8%)
ECE does not improve (out-of-sample)   : TRIGGERED  (identity=STUB(n<20), LOOCV=STUB(n<20))
Brier does not improve (out-of-sample) : clear  (identity=0.70504, LOOCV=0.70079)
```
Triggered reasons:
- DRAW share of LOOCV predictions (93.8%) exceeds 70%
- out-of-sample ECE did not improve (None -> None)
...
---
*Generated by R-1 Phase 2 evidence collector · 2026-06-16T12:03:01.201669+00:00*