...
18. MIW_SHADOW_LIVE_SIMULATION
19. MIW_SHARP_ANCHOR_CALIBRATION
20. MIW_SHARP_DATA_INFRASTRUCTURE
21. MIW_TRUTH_WAREHOUSE_BOOTSTRAP
22. MIW_PRODUCTION_CONTROL_PLANE
...
├── MIW_SHADOW_LIVE_SIMULATION.md
├── MIW_SHARP_ANCHOR_CALIBRATION.md
├── MIW_SHARP_DATA_INFRASTRUCTURE.md
├── MIW_TRUTH_WAREHOUSE_BOOTSTRAP.md
├── MIW_PRODUCTION_CONTROL_PLANE.md
└── MIW_SYSTEM_AUDIT.md
```
...
| 14 | MIW_SHADOW_LIVE_SIMULATION |
| 15 | MIW_SHARP_ANCHOR_CALIBRATION |
| 16 | MIW_SHARP_DATA_INFRASTRUCTURE |
| 16-bootstrap / R2 | MIW_TRUTH_WAREHOUSE_BOOTSTRAP |
| 17 | MIW_PRODUCTION_CONTROL_PLANE |
| R1 | MIW_R1_PAL_CORE |
